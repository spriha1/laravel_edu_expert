...
$(document).ready(function () {
  ...
  function stripeTokenHandler(token) {
    ...
    $.post('/post_stripe_payment', $('form').serialize(), function (result) {
      if (result === 'succeeded') {
        alert("paid");
      } else {
        alert(result);
...
module.exports = __webpack_require__(/*! /home/spriha/Documents/laravel/laravel_edu_expert/resources/js/stripe.js */"./resources/js/stripe.js");
